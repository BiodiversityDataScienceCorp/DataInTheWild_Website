...
```{r climate_data, message=FALSE, warning=FALSE}
...
```{r select_baseR, message=FALSE, warning=FALSE}
...
```{r select_tidy, message=FALSE, warning=FALSE}
...
```{r filter_baseR, message=FALSE, warning=FALSE}
# Base R
...
```{r filter_tidy, message=FALSE, warning=FALSE}
...
```{r nigeria30, message=FALSE, warning=FALSE}
...
```{r summarize_na.rm, message=FALSE, warning=FALSE}
...
```{r group_by_city, message=FALSE, warning=FALSE}
...
```{r group_by_city_country, message=FALSE, warning=FALSE}
